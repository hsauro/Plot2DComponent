...
//  cboYAXisColor.Color := gp.YAxisColor;
  ...
  if Plot.Series.Count > 0 then
     ...
     chkSeriesVisible.IsChecked := Plot.Series[0].Visible;
...
//     chkGradient.IsChecked := true;
  ...
  chkSeriesVisible.IsChecked := Plot.Series[YColumnIndex].Visible;
end;
...
begin
  ...
  Plot.Series[YColumnIndex].Visible := chkSeriesVisible.IsChecked;
  Plot.Redraw;
end;
